...
type V_AnalyticsWarehouseScaleMatcher = ValidateSQL<
    Q_AnalyticsWarehouseScale,
    AnalyticsWarehouseSchema
>;
type _A4 = RequireTrue<AssertEqual<V_AnalyticsWarehouseScaleMatcher, true>>;

type M_AnalyticsWarehouseScaleMatcher = QueryResult<
    Q_AnalyticsWarehouseScale,
    AnalyticsWarehouseSchema
>;
type _A5 = RequireTrue<
    AssertEqual<
        M_AnalyticsWarehouseScaleMatcher,
        {
            user_id: number;
            user_name: string;
            user_email: string;
...
export type AnalyticsMatcherTestsPass = true;
