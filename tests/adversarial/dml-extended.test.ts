/**
 * ADVERSARIAL: extended DML — INSERT...SELECT, UPDATE...FROM, DELETE...USING,
 * ON CONFLICT, multi-row VALUES, RETURNING (round 2).
 *
 * Mostly exercises situations the library already handles (green controls),
 * broadening coverage beyond the external insert/update/delete suites.
 */
...
export type DmlExtendedAdversarialLoaded = true;
